        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="{{ asset('images/' . $product->image) }}" alt="{{ $product->name }}"
                    class="mb-5 mt-5 img-fluid product-image">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="quantity">
                    ...
                    <input type="text" id="quantityInput" value="1" class="form-control d-inline-block"
                        style="width: 60px; text-align: center;">
                    <button class="btn btn-outline-secondary" id="increaseQuantity">+</button>
                </div>
                <div class="btn_main mt-3">
                    <button class="btn btn-primary" id="addToCart" data-id="{{ $product->id }}"
                        data-name="{{ $product->name }}" data-price="{{ $product->price }}">Ajouter au panier</button>
                </div>
            </div>
        </div>
    </div>
